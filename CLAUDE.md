...
- **/module/item_*.php**: Product listing and details
- **/module/buy_*.php**: Shopping cart and checkout
- **/module/member_*.php**: User account pages
- **/module/notice_*.php**: Announcements
...
- **/agency/, /category/, /member/, /order/, /product/**: Content management
...
- **stat_*.php**: Statistics pages (daily, weekly, monthly, by IP, etc.)
- **graph_*.php**: Graph rendering functions
...
- **최신 커밋**: 02dc1e4 (테이블 column 경계선 추가)
- **최신 태그**: v0.3.1-20251031
...
### Git 커밋 히스토리
```
v0.3.1-20251031  테이블 column 경계선 추가 - products.php 및 members.php
v0.3.0-20251031  자재 관리 시스템 개선 및 카테고리 관리 기능 구현
```

### 다음 주 작업 시 참고사항
- Branch는 main만 사용 (master 삭제됨)
- 각 기능 추가 후 태그 생성 및 푸시 필수
- parts.php의 Tab3-5는 아직 skeleton 상태 (향후 확장 예정)
- 모든 테이블은 일관된 CSS 스타일 적용됨 (border-right, table-layout: fixed, center alignment)