        ...
        <div class="content">
                ...
                <form method="GET" class="search-box date-filter" id="search-form-request">
                    ...
                    <div class="date-filter-buttons">
                        <button type="button" class="date-filter-btn <?php echo $range === '' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('all', 'search-form-request'); document.getElementById('search-form-request').submit();">전체
                            기간</button>
                        <button type="button" class="date-filter-btn <?php echo $range === 'today' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('today', 'search-form-request'); document.getElementById('search-form-request').submit();">오늘</button>
                        <button type="button" class="date-filter-btn <?php echo $range === 'week' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('week', 'search-form-request'); document.getElementById('search-form-request').submit();">금주</button>
                        <button type="button" class="date-filter-btn <?php echo $range === 'month' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('month', 'search-form-request'); document.getElementById('search-form-request').submit();">금월</button>
                        <button type="button" class="date-filter-btn <?php echo $range === 'year' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('year', 'search-form-request'); document.getElementById('search-form-request').submit();">금년</button>
                    </div>
            ...
            <div class="tab-content <?php echo $tab === 'completed' ? 'active' : ''; ?>" id="tab-completed">
                ...
                <form method="GET" class="search-box date-filter" id="search-form-completed">
                    ...
                    <div class="date-filter-buttons">
                        <button type="button" class="date-filter-btn <?php echo $range === '' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('all', 'search-form-completed'); document.getElementById('search-form-completed').submit();">전체
                            기간</button>
                        <button type="button" class="date-filter-btn <?php echo $range === 'today' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('today', 'search-form-completed'); document.getElementById('search-form-completed').submit();">오늘</button>
                        <button type="button" class="date-filter-btn <?php echo $range === 'week' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('week', 'search-form-completed'); document.getElementById('search-form-completed').submit();">금주</button>
                        <button type="button" class="date-filter-btn <?php echo $range === 'month' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('month', 'search-form-completed'); document.getElementById('search-form-completed').submit();">금월</button>
                        <button type="button" class="date-filter-btn <?php echo $range === 'year' ? 'active' : ''; ?>"
                            onclick="setOrderDateRange('year', 'search-form-completed'); document.getElementById('search-form-completed').submit();">금년</button>
                    </div>
