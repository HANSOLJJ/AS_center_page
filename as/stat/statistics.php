...
<body>
    ...
    <div class="nav-bar">
        ...
        <a href="statistics.php" class="nav-item active">통계/분석</a>
    </div>
                    ...
                    <div>
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="3" style="padding: 20px; text-align: center; color: #999;">조회된 수리 모델이 없습니다.
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                    ...
                    <div>
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="3" style="padding: 20px; text-align: center; color: #999;">조회된 교체 자재가 없습니다.
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
