...
// 제품 정보 조회
$result = mysql_query("SELECT * FROM step15_as_model WHERE s15_amid = $product_id LIMIT 1");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        ...
        $query = "UPDATE step15_as_model SET
            s15_model_name = '$model_name_esc',
            s15_model_sn = '$model_sn_esc'
        WHERE s15_amid = $product_id";
        ...
        <div class="form-container">
            <?php if ($success): ?>
                <div class="alert alert-success">
                    ✓ 제품이 정상적으로 수정되었습니다. 곧 목록 페이지로 이동합니다...
                </div>
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" id="model_name" name="model_name"
                            value="<?php echo htmlspecialchars($product['s15_model_name']); ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="model_sn">시리얼 및 버전 <span class="required">*</span></label>
                        <input type="text" id="model_sn" name="model_sn"
                            value="<?php echo htmlspecialchars($product['s15_model_sn']); ?>" required>
                    </div>
